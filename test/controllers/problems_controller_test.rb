...
class ProblemsControllerTest < ActionController::TestCase
  ...
  test "should create problem" do
    assert_difference('Problem.count') do
      post :create, problem: { color: @problem.color, logo: @problem.logo, name: @problem.name, url: @problem.url }
    end
  ...
  test "should update problem" do
    patch :update, id: @problem, problem: { color: @problem.color, logo: @problem.logo, name: @problem.name, url: @problem.url }
    assert_redirected_to problem_path(assigns(:problem))
  end
